# Generated by Django 2.2.5 on 2019-10-12 04:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='database.Listing')),
            ],
        ),
        migrations.CreateModel(
            name='MLSNumber',
        ...
        migrations.AddField(
            model_name='listing',
            name='agent',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.MLSNumber'),
        ),
        migrations.CreateModel(
            name='Room',
            fields=[
